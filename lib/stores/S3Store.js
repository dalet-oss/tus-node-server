...
class S3Store extends DataStore {
     ...
     */
    _uploadPart(metadata, read_stream, current_part_number, start_offset) {

        return new Promise((resolve, reject) => {
            const progressEmitter = this._getUploadingProgressEmitter();
            let uploadedLength = start_offset;
     ...
     * @memberof S3Store
     */
    _processUpload(metadata, req, current_part_number, start_offset) {
        return this._uploadPart(metadata, req, current_part_number, start_offset)
